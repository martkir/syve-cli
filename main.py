...
def download(slug, from_timestamp, until_timestamp, data_dir, size=5001):
...
def main(slug, from_timestamp, until_timestamp, data_dir):
    download(slug, from_timestamp, until_timestamp, data_dir)
